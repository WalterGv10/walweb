...
export function History() {
    const timeline = [
        ...
        },
        {
            ...
            desc: "Me adentré en el mundo del desarrollo web, entendiendo que el futuro estaba en internet.",
            icon: "🌐",
        },
        {
            year: "2020",
            title: "Sistemas Reales",
            desc: "Creación de sistemas de inventario y plataformas complejas para emprendimientos reales.",
            icon: "📊",
        },
        {
            year: "Presente",
